...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <div class="container">
        <div >
          <center> <a href="Tour/create" class="btn btn-danger float-right"> <i class="fa fa-plus" aria-hidden="true"></i></a>
          </center>
        </div>
        <br>
        <table class="table table-striped">
          ...
          @foreach($tour as $post)
            <tr>
              ...
              <td><a href="{{action('TourController@edit', $post['id'])}}" class="btn btn-warning">Edit</a></td>
              <td>
