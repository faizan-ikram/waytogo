        ...
        <div class="container  col-lg-6 col-md-6 col-sm-6" >
            ...
            <form method="post" action="{{url('Travel')}}">
                ...
                <div class="form-group row">
                    ...
                    <label for="lgFormGroupInput" class="col-md-2 col-form-label  col-form-label-sm">CompanyName</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control form-control-sm" id="lgFormGroupInput" placeholder="title" name="CompanyName">
                    </div>
                </div>
                <div class="form-group row">

                    <label for="lgFormGroupInput" class="col-md-2 col-form-label  col-form-label-sm">Email</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control form-control-sm" id="lgFormGroupInput" placeholder="title" name="email">
                    </div>
                </div>
                <div class="form-group row">

                    <label for="lgFormGroupInput" class="col-md-2 col-form-label  col-form-label-sm">Password</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control form-control-sm" id="lgFormGroupInput" placeholder="title" name="password">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <center> <button type="submit" class="btn btn-primary float-right">Submit</button></center>
                    </div>
